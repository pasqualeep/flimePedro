...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
     <nav className = "flex items-end gap-4 justify-between bg-cyan-800 w-full p-3">
      <h1 className='flex items-center gap-2 text-5xl text-gray-200	font-bold uppercase'> 
